      ...
      <section className="relative pt-16 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground text-center mb-6">
            From Inbox Chaos to Travel Plans, <span className="text-primary">Effortlessly</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-center mb-10">
            Globeplot helps you organize multi-stop travel itineraries in one place. 
            Upload confirmations, track events, and share your perfect journey.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/dashboard" className="bg-primary text-primary-foreground px-8 py-3 rounded-full text-md font-medium hover:bg-primary/90 transition-colors shadow-sm text-center">
              Get Started
            </Link>
            <Link to="/demo" className="bg-white border border-border text-foreground px-8 py-3 rounded-full text-md font-medium hover:bg-secondary/20 transition-colors text-center">
              View Demo
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground text-sm">
                Start by creating a trip and adding multiple stops to build your perfect itinerary.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground text-sm">
                Add flights, hotels, activities, and more to each stop of your journey.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground text-sm">
                Generate shareable links or export your trip as a printable PDF.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-br from-primary/5 to-accent/5">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Join thousands of travelers who use Globeplot to organize their multi-stop journeys.
          </p>
          <Link to="/dashboard" className="inline-block bg-primary text-primary-foreground px-8 py-3 rounded-full text-md font-medium hover:bg-primary/90 transition-colors shadow-sm">
            Start Planning Now
          </Link>
